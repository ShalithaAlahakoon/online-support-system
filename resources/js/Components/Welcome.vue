...
import GradientLineChart from "@/Components/Chart/GradientLineChart.vue";
import ReportsBarChart from "@/Components/Chart/ReportsBarChart.vue";
</script>
                        ...
                        <div class="flex-auto p-4">
                            <div class="flex flex-wrap -mx-3">
                                <div class="flex-none w-2/3 max-w-full px-3">
                                    <div>
                                        <p class="mb-0 font-sans text-sm font-semibold leading-normal dark:opacity-60">
                                            Today's Money</p>
                                ...
                                <div class="w-4/12 max-w-full px-3 text-right flex-0">
                                    <div
                                        class="inline-block w-12 h-12 text-center rounded-lg bg-primary shadow-soft-2xl">
                            ...
                            <table class="items-center w-full mb-4 align-top border-gray-200 dark:border-white/40">
                                ...
                                <tr>
                                    <td class="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                                        <div class="flex items-center px-2 py-1">
                                            <div>
                                                <img :src="$page.props.assetURL ? $page.props.assetURL + '/img/icons/flags/US.png':'img/icons/flags/US.png'" alt="Country flag"/>
                                            </div>
                                            <div class="ml-6">
                                ...
                                <tr>
                                    <td class="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                                        <div class="flex items-center px-2 py-1">
                                            <div>
                                                <img :src="$page.props.assetURL ? $page.props.assetURL + '/img/icons/flags/DE.png':'img/icons/flags/DE.png'" alt="Country flag"/>
                                            </div>
                                            <div class="ml-6">
                                                <p class="mb-0 text-xs font-semibold leading-tight dark:opacity-60">
                                                    Country:</p>
                                ...
                                <tr>
                                    <td class="p-2 align-middle bg-transparent border-b w-3/10 whitespace-nowrap dark:border-white/40">
                                        <div class="flex items-center px-2 py-1">
                                            <div>
                                                <img :src="$page.props.assetURL ? $page.props.assetURL + '/img/icons/flags/GB.png':'img/icons/flags/GB.png'" alt="Country flag"/>
                                            </div>
                                            <div class="ml-6">
                                                <p class="mb-0 text-xs font-semibold leading-tight dark:opacity-60">
                                                    Country:</p>
                                ...
                                <tr>
                                    <td class="p-2 align-middle bg-transparent border-0 w-3/10 whitespace-nowrap">
                                        <div class="flex items-center px-2 py-1">
                                            <div>
                                                <img :src="$page.props.assetURL ? $page.props.assetURL + '/img/icons/flags/BR.png':'img/icons/flags/BR.png'" alt="Country flag"/>
                                            </div>
                                            <div class="ml-6">
                                                <p class="mb-0 text-xs font-semibold leading-tight dark:opacity-60">
                                                    Country:</p>
    ...
    <div class="flex flex-wrap mt-6 -mx-3">
        <div class="w-full max-w-full px-3 mt-0 mb-6 lg:mb-0 lg:w-5/12 lg:flex-none">
            <div
                ...
                <div class="flex-auto p-4">
                    <div
                        class="py-4 pr-1 mb-4 bg-primary rounded-xl">
                        <div>
                            <ReportsBarChart
                                id="chart-bar"
                                title="active Users"
                ...
                datasets: {
                  label: 'Sales',
                  data: [450, 200, 100, 500, 600, 100, 400, 230, 500],
                },
              }"
                                :items="[
                {
                ...
                },
                {
                  ...
                  progress: { content: '43', percentage: 50 },
                    ...
                    <p class="ml-2 text-sm leading-normal dark:opacity-60">(<span class="font-bold">+23%</span>) than
                        last week</p>
                    <div class="w-full px-6 mx-auto max-w-screen-2xl rounded-xl">
                        <div class="flex flex-wrap mt-0 -mx-3">
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                <div class="flex mb-2">
                                    <div
                                        class="flex items-center justify-center w-5 h-5 mr-2 text-center bg-center rounded fill-current shadow-soft-2xl bg-gold-900 text-neutral-900">
                            ...
                            <div class="flex-none w-1/4 max-w-full py-4 pl-0 pr-3 mt-0">
                                ...
                                <div class="text-xs h-0.75 flex w-3/4 overflow-visible rounded-lg bg-gray-200">
                                    <div
                                        class="duration-600 ease-soft -mt-0.4 -ml-px flex h-1.5 w-1/2 flex-col justify-center overflow-hidden whitespace-nowrap rounded-lg bg-slate-700 text-center text-white transition-all"
        ...
        <div class="w-full max-w-full px-3 mt-0 lg:w-7/12 lg:flex-none">
            <div
              ...
              datasets: [
                ...
                {
                  label: 'Websites',
                  data: [30, 90, 400, 140, 290, 290, 340, 230, 400],
                },
              ],
            }"/>
                    </div>
