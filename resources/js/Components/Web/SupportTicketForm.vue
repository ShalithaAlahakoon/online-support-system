...
<template>
    <form @submit.prevent="supportTicket" class="w-full h-full bg-purple-900">
        <div class="w-full h-full bg-purple-900">
            <div class="container">
                <div class="text-center py-10">
                    <div class="text-2xl sm:text-5xl text-white font-bold my-5">
                        Welcome to Our Online Support Center
                    </div>
                    <div class="text-sm sm:text-lg text-white font-medium max-w-[80ch] mx-auto">
                        Our Online Support Center is your gateway to efficient
                        assistance and guidance. We're here to address your
                        inquiries and provide solutions, ensuring a seamless
                        experience.
                    </div>
                </div>
                <div class="mt-10 rounded-3 flex justify-center xl:w-2/4 mx-auto bg-white">
                    <div class="w-4/5 mb-10">
                        ...
                        <div class="relative text-center lg:text-left mt-10">
                            <input type="text" id="phone_number" v-model="form.phone_number"
                                ...
                                placeholder=" " />
                            <label for="floating_filled"
                                class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Phone
                                Number</label>
                            <InputError class="mt-2" :message="form.errors.phone_number" />
                        </div>
                        <div class="relative text-center lg:text-left mt-10">
                            <input type="text" id="description" v-model="form.problem_description"
                                ...
                                placeholder=" " />
                            <label for="floating_filled"
                                class="absolute text-sm text-gray-500 dark:text-gray-400 duration-300 transform -translate-y-4 scale-75 top-4 z-10 origin-[0] left-2.5 peer-focus:text-blue-600 peer-focus:dark:text-blue-500 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-y-0 peer-focus:scale-75 peer-focus:-translate-y-4">Problem
                                Description</label>
