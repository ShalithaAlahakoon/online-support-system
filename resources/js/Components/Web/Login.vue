                ...
                <div class="bg-primary text-center xl:text-left Left-section mt-10 lg:mt-20">
                    ...
                    <div class="flex justify-between w-full xl:w-4/5">
                        <div class="flex items-center">
                            <Checkbox v-model:checked="form.remember" name="remember" class="w-4 h-4 form-checkbox text-primary"/>
                            <div for="link-checkbox" class="ml-2 text-sm ms:text-base font-normal text-white">Remember me</div>
                        </div>
                        <div for="link-checkbox" class="ml-2 text-sm sm:text-base font-normal text-white">
                            <Link v-if="canResetPassword" :href="route('password.request')">Forget password?</Link>
                        </div>
                    </div>
                    <div class="w-full xl:w-4/5 mt-5 xl:mt-10 flex justify-center xl:justify-start">
                        <PrimaryButton
                            btnClass="login-btn text-center text-base sm:text-xl text-white font-normal bg-gold-900 rounded-full w-full py-3 my-8" :class="{ 'opacity-25': form.processing }" :disabled="form.processing">
                            Login
                        </PrimaryButton>
                    </div>
                    </form>
