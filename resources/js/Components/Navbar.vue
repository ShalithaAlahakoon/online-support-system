...
<template>
    ...
    <nav navbar-main
        ...
        <div class="flex items-center justify-between w-full px-4 py-1 mx-auto flex-wrap-inherit">
            <nav>
                <!-- breadcrumb -->
                <Breadcrumb :current-page="currentPage" :backUrl="backUrl" />
            </nav>
            ...
            <div class="flex items-center mt-2 grow sm:mt-0 sm:mr-6 md:mr-0 lg:flex lg:basis-auto" id="navbar">
                ...
                <ul class="flex flex-row justify-end pl-0 mb-0 list-none md-max:w-full">
                    <li class="flex items-center">
                        <NavLink style="padding-right: 5px" :href="route('profile.show')"
                                 class="font-semibold text-gray-600 hover:text-gray-900 dark:text-gray-400 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">
                            <i class="fa fa-user sm:mr-1" aria-hidden="true"></i>
                            {{ $page.props.auth.user ? $page.props.auth.user.name + " | " : "Sign In" }}
                        </NavLink>
                        <form @submit.prevent="logout">
                            <button>
                                <i class="fa fa-sign-out text-slate-400 dark:text-white/70"></i>
                            </button>
                        </form>
                    </li>
